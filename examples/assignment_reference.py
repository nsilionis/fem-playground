...
def euler_bernoulli_point_load(x, L, P, E, I):
    """
...
def main():
    ...
    print(f"  Displacement plots: 2")
    print(f"  Error plots: 2")
    print(f"  Stress contour plots: 10 (8×1 reduced skipped)")
